...
/**
 * Form Request para atualização de contatos
 *
 * Valida todos os dados necessários para atualizar um contato existente,
 * incluindo validação de CPF e unicidade por usuário (exceto o próprio contato).
 */
class ContactUpdateRequest extends FormRequest
{
    ...
    {
        return true; // Autorização é feita pela Policy
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'cpf' => ['sometimes', 'required', 'string', 'size:11'], // CPF sem formatação (apenas números)
            ...
            'zip_code' => ['sometimes', 'required', 'string', 'size:8'], // CEP sem formatação (apenas números)
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator) {
            ...
            // Verifica se o CPF já está cadastrado para este usuário (exceto o contato atual)
    ...
    protected function prepareForValidation(): void
    {
        ...
        // Remove formatação do CEP se fornecido
        if ($this->zip_code) {
            $this->merge([
        ...
        // Normaliza o estado para maiúsculo se fornecido
        if ($this->state) {
            $this->merge([
